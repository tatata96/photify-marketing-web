  ...
  return (
    <section className="contact-section" id="contact">
      <div className="container">
        <div className="contact-section-inner" data-reveal>
          <span className="section-label">{t('contact.label')}</span>
          <h2 className="section-heading">{t('contact.heading')}</h2>
          <p className="contact-section-sub">{t('contact.sub')}</p>

          <div className="contact-card">
            <a className="contact-link" href="mailto:info@photify.com">
          ...
          <div className="contact-socials">
            <a
              ...
              href="tel:+905404550218"
              aria-label="Call Photify"
            >
