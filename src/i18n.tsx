...
const en: Dict = {
  ...
  'solution.heading': 'A selfie becomes the search query.',
  ...
  'features.heading': 'A Simpler Way to Find Your Photos',
  'features.subtext': 'From phone verification to a personal gallery — see exactly how guests find their photos in under a minute, with facial recognition working quietly in the background.',
  'features.hint': 'Tap a step to explore the screens.',
  'features.s1.label': 'Phone Verification',
  'features.s1.text': 'Guests create an account with their phone number and a one-time code — simple, secure onboarding.',
  'features.s2.label': 'Upload a Selfie',
  'features.s2.text': "A selfie becomes each guest's visual identifier, matching them to every photo they appear in.",
  'features.s3.label': 'Scan the Event QR',
  'features.s3.text': 'Guests scan a QR code at the venue to join the event instantly — no manual search required.',
  'features.s4.label': 'Track Your Event',
  'features.s4.text': "Guests see every event they've joined and follow the status of photo matching in real time.",
  'features.s5.label': 'Personal Gallery',
  'features.s5.text': "Once matching finishes, guests get a personal gallery with only the photos they're actually in.",
  ...
  'create.package.title': 'Event Package',
  'create.package.priceLabel': 'Starting price',
  'create.package.price': '₺3.000',
  'create.package.note': 'Price may vary depending on event details.',
  'create.package.includes': 'Package includes',
  'create.package.feature1': '1 Event',
  'create.package.feature2': '50 GB Storage',
  'create.package.feature3': 'All participants can access',
  'create.package.feature4': '3 Months Access',
...
const tr: Dict = {
  ...
  'solution.heading': 'Selfie, arama sorgusu haline gelir.',
  ...
  'features.heading': 'Fotoğraflarınızı Bulmanın Daha Kolay Yolu',
  'features.subtext': 'Telefon doğrulamasından kişisel galerinize kadar — misafirlerin fotoğraflarını bir dakikadan kısa sürede nasıl bulduğunu görün; yüz tanıma arka planda sessizce çalışır.',
  'features.hint': 'Ekranları görmek için bir adıma dokunun.',
  'features.s1.label': 'Telefon Doğrulama',
  'features.s1.text': 'Misafirler telefon numaraları ve tek seferlik bir kodla hesap oluşturur — basit ve güvenli bir katılım deneyimi.',
  'features.s2.label': 'Selfie Yükle',
  'features.s2.text': 'Bir selfie, her misafirin görsel kimliği olur ve içinde yer aldıkları tüm fotoğraflarla eşleştirilir.',
  'features.s3.label': 'Etkinlik QR Kodunu Okut',
  'features.s3.text': 'Misafirler mekandaki QR kodu okutarak etkinliğe anında katılır — manuel arama gerekmez.',
  'features.s4.label': 'Etkinliğini Takip Et',
  'features.s4.text': 'Misafirler katıldıkları tüm etkinlikleri görür ve fotoğraf eşleştirme durumunu gerçek zamanlı izler.',
  'features.s5.label': 'Kişisel Galeri',
  'features.s5.text': 'Eşleştirme tamamlandığında misafirler yalnızca kendi göründükleri fotoğrafları içeren kişisel bir galeri alır.',
  ...
  'create.form.title': 'Etkinliğinizi birlikte planlayalım',
  'create.form.sub': 'Bize etkinliğinizle ilgili birkaç detay bırakın, size özel teklifimizle en kısa sürede geri dönelim.',
  ...
  'create.package.title': 'Etkinlik Paketi',
  'create.package.priceLabel': 'Başlangıç fiyatı',
  'create.package.price': '₺3.000',
  'create.package.note': 'Etkinlik detaylarına göre fiyat değişebilir.',
  'create.package.includes': 'Paket içeriği',
  'create.package.feature1': '1 Etkinlik',
  'create.package.feature2': '50 GB Depolama',
  'create.package.feature3': 'Bütün katılımcılar erişebilir',
  'create.package.feature4': '3 Ay Erişim',
